class VM {
    ...
    void operationSetup() {
        ...
        paramModes = new int[]{(int)(mem[ptr])%1_000/100, (int)(mem[ptr])%10_000/1_000, (int)(mem[ptr])%100_000/10_000};

        int maxParameters = Math.min(3, mem.length - ptr - 1);
        args = new int[maxParameters];
